        ...
        <div className='footer-sections'>
          ...
          <div className='footer-right'>
            ...
            <div className="footer-section2">
                <p><a href="#" onClick={(e) => { e.preventDefault(); }}>이용약관 . 법적고지</a></p>
                <p><a href="#" onClick={(e) => { e.preventDefault(); }}>개인정보처리방침</a></p>
                <p><a href="#" onClick={(e) => { e.preventDefault(); }}>청소년보호방침</a></p>
                <p><a href="#" onClick={(e) => { e.preventDefault(); }}>영상정보처리기기운영/관리 방침</a></p>
                <p><a href="#" onClick={(e) => { e.preventDefault(); }}>이메일무단수집거부</a></p>
            </div>
